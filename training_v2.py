...
class StockNN(nn.Module):
    ...
    Inject (×14):     (120+5i)+60     → FC → 125+5i  (grows 120→190)
...
class MasterNN(nn.Module):
    ...
    Inject (×14):     (120+5i)+61     → FC → 125+5i  (grows 120→190)
    Today:            190+229=419     → FC → 300
    Flat:             300             → FC → 300  (×2)
    Funnel:           300→234→168→102→36

    Output (1,36):
      [:12]   Softmax  → allocation weights
      [12:24] Sigmoid  → liquidation depth per industry
